...
| Hooks | 宿主支持时拦截高风险动作 | 危险命令、密钥文件编辑 |
...
| 宿主 | v1 目标 | 强制能力 |
| --- | --- | --- |
| Codex | 指令、skills、验证脚本、Git checkpoint 工作流 | 强提示约束，加上可用的 Git hooks |
| Claude Code | 指令、skills、验证脚本、生命周期 hooks、Git checkpoint 工作流 | 通过 hooks 获得更强的确定性拦截 |
